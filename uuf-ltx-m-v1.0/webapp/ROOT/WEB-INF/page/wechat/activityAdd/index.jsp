...
<form style="margin-top: 10px;" id="listForm" action="${request.getContextPath}/wechat/activity/showActivitys" method="post">
...
<script type="text/javascript">
	...
	function showDetail(obj){
		var id = $(obj).attr("ref");
		var url="${request.getContextPath}/wechat/activity/showActivityOne?id="+id;
