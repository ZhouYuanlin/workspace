				...
				<div class="portlet-body">
					<div class="search-div" style="height: 160px;">
						<ul class="list-group">
							...
							<a href="${request.getContextPath}/admin/qgzx/bcgl">待确认报酬条数<span
									class="badge badge-danger pull-right">${bcts}</span></a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="portlet box grey">
				...
				<div class="portlet-body">
					<div class="search-div" style="height: 160px;">
						<ul class="list-group">
							<li class="list-group-item">
							<a href="${request.getContextPath}/admin/qgzx/gwsq/ysqgw">已经申请的岗位数<span
									class="badge badge-danger pull-right">${ysqgws}</span></a></li>
							<li class="list-group-item">
							<a href="${request.getContextPath}/admin/qgzx/gwsq/ysqgw">待审批的岗位数<span
									class="badge badge-danger pull-right">${dspgws}</span></a></li>
							<li class="list-group-item">		
							<a href="${request.getContextPath}/admin/qgzx/gwsq/ysqgw">申请通过的岗位数<span
									class="badge badge-danger pull-right">${ytggws}</span></a></li>		
						</ul>
					</div>
				</div>
			</div>
