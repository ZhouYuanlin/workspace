...
<body>
   ...
   <form id="pwdresetForm" action="<c:url value='${request.contextPath}/wechat/personal/repwd'/>" method="post">
    <div class="aui-card">
        <div class="aui-form">
            ...
            <div class="aui-input-row">
                ...
                <input type="password" id="rpwd" class="aui-input" placeholder="请确认密码"/>
            </div>
...
<script type="text/javascript">
	...
	function doRepwd(){
		...
		$('#pwdresetForm').attr('action','${request.contextPath}/wechat/personal/repwd').submit();
	}
</script>
</html>