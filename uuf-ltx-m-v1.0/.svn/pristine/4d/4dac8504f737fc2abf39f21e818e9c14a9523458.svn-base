        ...
        <div class="userimg">
	        <c:choose>
	        	<c:when test="${empty file}">
	        		<c:choose>
		        		<c:when test="${personal.xb=='男'}">
		        			<img src="${request.getContextPath}/upload/photo/111.jpg" alt="" style="width: 102px;height: 102px"/>
		        		</c:when>
		        		<c:otherwise>
		        			<img src="${request.getContextPath}/upload/photo/222.jpg" alt="" style="width: 102px;height: 102px"/>
		        		</c:otherwise>
	        		</c:choose>
	        	</c:when>
	        	<c:otherwise>
		       		<img src="${request.getContextPath}/upload/photo/${personal.sfzh}.jpg" alt="" style="width: 102px;height: 102px"/>
	        	</c:otherwise>
	        </c:choose>
        </div>
        <div class="username">
...
<div class="content">
	...
	<div class="container">
		<c:if test="${fn:length(address)<13}">
			<div class="row">
