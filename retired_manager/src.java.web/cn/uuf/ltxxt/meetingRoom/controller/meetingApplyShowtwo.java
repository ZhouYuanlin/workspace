...
@Controller
@RequestMapping("{meetingApplyShowtwo:meetingApplyShowtwo;*.?}")
public class meetingApplyShowtwo extends BaseController{
	/**
	 * 会议室图形化界面
	 */
    private final String LIST_ACTION = "redirect:/meetingApplyShowtwo";
	...
	public ModelAndView index(@RequestParam(defaultValue="1") Integer page,MeetingApply m,MeetingRoom mr,String carNumber,String carDriver,String times,String onclickState){
		ModelAndView mav = new ModelAndView("meeting/meetingApply/indextwo");
		try{
		 ...
		 @RequestMapping("{ajaxdetail:ajaxdetail;*.?}")
			public ModelAndView ajaxDetail(HttpServletResponse response,Long id,String useTime){
				...
				if(!useTime.equals("12315")){
					 mav = new ModelAndView("meeting/meetingApply/_workstwo");
