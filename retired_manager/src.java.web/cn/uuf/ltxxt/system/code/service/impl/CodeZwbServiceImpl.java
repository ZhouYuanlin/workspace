 ...
 */
@Service
public class CodeZwbServiceImpl extends HibernateDaoSupport<CodeZwb,Long> implements CodeZwbService{

	@SuppressWarnings("unchecked")
	@Override
	public List<CodeZwb> getAll() {
		Criteria c = getSession().createCriteria(CodeZwb.class);
	...
	@Override
	public Long getCount(CodeZwb m) {
	...
	@Override
	public List<CodeZwb> queryList(CodeZwb m, int s, int size) {
		Criteria c = buildCondition(m);
		c.setFirstResult(s).setMaxResults(size);
		return this.queryByPage(c);
	}
	
	private Criteria buildCondition(CodeZwb m){
		Criteria c = getSession().createCriteria(CodeZwb.class);
		if(m != null){
