				...
				<div class="col-md-12">
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<a href="${request.contextPath}/codektlb/">
							首页 </a>
			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/codektlb/update'/>" class="form-horizontal" method="post">
											<input type="hidden" name="id" value="${lxb.id}"/>
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label"><i style="color:red;margin-right:5px;">*</i>课堂类型代码：</label>
															<div class="controls">
