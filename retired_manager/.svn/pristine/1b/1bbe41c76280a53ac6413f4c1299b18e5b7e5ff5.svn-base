...
<body>
				...
				<div class="col-md-12">
					<ul class="page-breadcrumb breadcrumb">
						<li><i class="fa fa-home"></i> <a
							href="${request.contextPath}/carApply"> 首页 </a> <i
							class="fa fa-angle-right"></i></li>
						<li><a href="${request.contextPath}/carApply"> 车辆使用申请 </a> <i
							class="fa fa-angle-right"></i></li>
						<li><a href="${request.contextPath}/carApply"> 增加 </a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box grey">
						...
						<div class="portlet-body form">
							<form id="frm"
								action="<c:url value='${request.contextPath}/carApply/save'/>"
								...
								<div class="form-body">
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i
													style="color: red; margin-right: 5px;">*</i>申请使用日期：</label>
												<div class="controls">
													<input type="text" id="useTime" name="useTime" value=""
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i
													style="color: red; margin-right: 5px;">*</i>申请使用开始时间：</label>
												<div class="controls">
													<div class="input-group">
														<span class="input-group-btn"> <input type="text"
															id="startTime" name="startTime"
															value="<c:if test='${empty w.kssj}'><fmt:formatDate value='${w.createDate}' pattern='HH:mm'/></c:if><c:if test='${!empty w.kssj}'>${w.kssj}</c:if>"
															class="form-control timepicker timepicker-24"
															style="width: 120px;">
															<button class="btn default timepicker-btn" type="button">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i
													style="color: red; margin-right: 5px;">*</i>申请使用结束时间：</label>
												<div class="controls">
													<div class="input-group">
														<span class="input-group-btn"> <input type="text"
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i
													style="color: red; margin-right: 5px;">*</i>可坐人数：</label>
												<div class="controls">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i
													style="color: red; margin-right: 5px;">*</i>申请人电话：</label>
												<div class="controls">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="controls">
													<textarea id="peason" name="peason"
														class="form-control col-md-12" style="height: 300px;"></textarea>
												</div>
											</div>
										</div>
									</div>
	...
	KindEditor.ready(function(K) {
		...
		$(function() {
			...
			$('.timepicker').parent('.input-group-btn').on(
					'click',
					'.timepicker-btn',
					function(e) {
						e.preventDefault();
						$(this).parent('.input-group-btn').find('.timepicker')
								.timepicker('showWidget');
					});
		});
		$(function() {
			$('.wzbtn').click(function() {
				if ($('#carinfoId').val() == null) {
					alert("请选择车辆名称及型号");
					$('#carinfoId').focus();
					return false;
				}
				...
				editor1.sync();
				html=document.getElementById('peason').value;
				if (html.length==0) {
					alert("申请使用原因不能为空！");
					$('#useTime').focus();
					return false;
