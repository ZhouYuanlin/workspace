			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/account/save'/>" class="form-horizontal" method="post">
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="controls">
																<input type="text" name="lxdh" class="form-control col-md-12"/>
															</div>
														</div>
													</div>
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<input type="text" name="role" class="form-control col-md-12 date-picker" data-date-format="yyyy-mm-dd" size="16" readonly/>
															</div>
														</div>
													</div>
												</div>
																...
																<c:set var="xsrole" value="<%=cn.uuf.contants.Constants.INFOGR%>"/>
									                             <c:forEach items="${roleList}" var="item" varStatus="c">
									                              <label class="checkbox inline">
									                                <c:if test="${item.scope != xsrole}"><input type="checkbox" name="rId" id="rId" class="rolesClass" ref="${item.scope}" value="${item.id}"/>${item.name}</c:if>
									                            </label>
									                            </c:forEach>
															</div>
														</div>
