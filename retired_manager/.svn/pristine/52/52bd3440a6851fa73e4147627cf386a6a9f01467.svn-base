			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/codezdytjb/save'/>" class="form-horizontal" method="post">
											<input type="hidden" value="${zdtjb.tjb.id}">
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
													...
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label"><i style="color:red;margin-right:5px;">*</i>所属表：</label>
															<div class="controls">
																<select id="texttype" name="tjb.id" class="form-control col-md-12">
																    <option value="">--请选择--</option>
																    <c:forEach items="${tjbList}" var="item">
																		<option value="${item.id}">${item.tjbzwm}</option>
																    </c:forEach>
																</select>
															</div>
														</div>
