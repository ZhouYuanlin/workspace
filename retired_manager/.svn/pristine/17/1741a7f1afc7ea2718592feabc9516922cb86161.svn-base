				...
				<div class="col-md-12">
					<ul class="page-breadcrumb breadcrumb">
						<li><i class="fa fa-home"></i> <a
							href="${request.contextPath}/meetingRoom/"> 首页 </a> <i
							class="fa fa-angle-right"></i></li>
						<li><a href="${request.contextPath}/meetingRoom/"> 会议室管理
						</a> <i class="fa fa-angle-right"></i></li>
						<li><a href="${request.contextPath}/meetingRoom/"> 增加 </a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box grey">
						...
						<div class="portlet-body form">
							<form id="frm" action="<c:url value='${request.contextPath}/meetingRoom/save'/>" class="form-horizontal" method="post">
								<div class="form-body">
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i style="color: red; margin-right: 5px;">*</i>名称：</label>
												<div class="controls">
													<input type="text" id="name" name="name" value="${meeting.name}" class="form-control col-md-12" />
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i style="color: red; margin-right: 5px;">*</i>使用设备：</label>
												<div class="controls">
													<input type="text" id="device" name="device" value="${meeting.device}" class="form-control col-md-12" />
												</div>
											</div>
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"><i
													style="color: red; margin-right: 5px;">*</i>使用人数：</label>
												<div class="controls">
											...
											<div class="form-group">
												...
												<div class="controls">
													<textarea id="description" name="description"
														class="form-control col-md-12" style="height: 300px;">${meeting.description}</textarea>
												</div>
											</div>
										</div>
											...
											<div class="form-group">
												...
												<div class="controls" id="siteWebLog">
													...
													<xxs:commonupload id="siteWebLog" uploadType="1" type="1"
														...
														sizeLimit="10 MB" srcImg="${meeting.imgurl}" showText="true"
														styleClass="text_4" />
												</div>
											</div>
										</div>
	...
	$(function(){
		$('.wzbtn').click(function(){
			...
			if($('#upperLimit').val() == ""){
			   ...
			   var re = /^[1-9]+[0-9]*]*$/;
			   if (!re.test($('#upperLimit').val())){
				alert("使用人数格式错误，请输入正整数！");
				$('#upperLimit').focus();
				return false;
			}
			if($('#enableState').val() == ""){
