			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/retlabel/save'/>" class="form-horizontal" method="post">
											<div class="form-body">
														...
														<div class="form-group">
															...
															<div class="controls">
																<c:forEach items="${bjbjlist}" var="item">
																	<input type="checkbox" id="bjbj" name="bjbj" value="${item.name}" class="bjs"/>${item.name}
																</c:forEach>
															</div>
														</div>
													</div>
