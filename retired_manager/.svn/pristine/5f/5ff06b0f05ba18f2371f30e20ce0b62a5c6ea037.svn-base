			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/retphone/save'/>" class="form-horizontal" method="post">
											<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="controls">
																<input type="text" id="lxrq" name="lxrq" value="${retphone.lxrq}" class="form-control col-md-12 date-picker" data-date-format="yyyy-mm-dd" size="20" readonly/>
															</div>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-12">
                                                        <div class="form-group">
															...
															<div class="controls">
																<textarea rows="5" cols="40" id="lxxq" name="lxxq" class="form-control col-md-12"></textarea>
															</div>
														</div>
													</div>
												</div>
