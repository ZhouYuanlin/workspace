				...
				<div class="col-md-12">
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<a href="${request.contextPath}/codewwlx/">
							首页 </a>
			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/codewwlx/save'/>" class="form-horizontal" method="post">
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label"><i style="color:red;margin-right:5px;">*</i>慰问类型代码：</label>
															<div class="controls">
													...
													<div class="col-md-4">
                                                        <div class="form-group">
															<label class="control-label">慰问类型名称：</label>
															<div class="controls">
