			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/rethoscost/save'/>" class="form-horizontal" method="post">
											<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<input type="text" id="zfxm" name="zfxm" value="${r.zfxm}" class="form-control col-md-12">
															</div>
														</div>
													</div>
													...
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<input type="text" id="zfje" name="zfje" value="${r.zfje}" class="form-control col-md-12">
															</div>
														</div>
													</div>
