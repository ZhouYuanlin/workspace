			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/retireactother/update'/>" class="form-horizontal" method="post">
											<input type="hidden" name="id" value="${p.id}"/>
											<input type="hidden" name="cyry" id="cyry" value="${p.cyry}"/>
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="controls">
																<input style="width:95%;" type="text" id="name" name="name" value="${p.name}" class="form-control col-md-12"/>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="controls">
																<input style="width:95%;" type="text" id="hddd" name="hddd" value="${p.hddd}" class="form-control col-md-12"/>
															</div>
														</div>
													</div>
													<div class="col-md-4">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="controls">
																<a href="#showdetail" id="approve1" class="black" data-toggle="modal"><input style="width:95%;" type="text" id="cyrys" name="cyrys" value="${p.cyrys}" class="form-control col-md-12" readonly></a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="controls" id="siteWebLog">
			    												...
			    												<xxs:commonupload id="siteWebLog" uploadType="1" type="1" name="imgurl" fileTypes="*.jpg;*.gif;*.png" sizeLimit="10 MB" srcImg="${p.imgurl}" showText="true" styleClass="text_4" />
															</div>
														</div>
													</div>
												</div>
