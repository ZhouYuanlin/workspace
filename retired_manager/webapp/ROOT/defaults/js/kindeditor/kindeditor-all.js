...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var dialogWidth = showLocal || allowFileManager ? 420 : 400,
			...
			afterUpload : function(data) {
				...
				if (data.error === 0) {
					...
					if (!fillDescAfterUploadImage) {
						clickFn.call(self, url, data.title, data, data.height, data.border, data.align);
					} else {
