			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/assetSub/useSuccess'/>" class="form-horizontal" method="post">
											<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<input type="text" id="assetManage.name" name="assetManage.name" value="${assetSub.assetManage.name}" class="form-control col-md-12"readonly="readonly"/>
															</div>
														</div>
													</div>
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<input type="text" id="assetManage.version" name="assetManage.version" value="${assetSub.assetManage.version}" class="form-control col-md-12"readonly="readonly"/>
															</div>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<select name="usePerson" class="form-control col-md-12">
																   <option value="">--请选择--</option>
																	<c:forEach items="${recordList}" var="item">
																		<option value="${item.name}" <c:if test="${assetSub.usePerson == item.name}">selected</c:if>>${item.name}</option>
																	</c:forEach>
																</select>
															</div>
														</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="controls">
																<input type="text" id="useDate" name="useDate" value="${assetSub.useDate}" class="form-control col-md-12 date-picker" data-date-format="yyyy-mm-dd" size="16" readonly/>
															</div>
														</div>
													</div>
													</div>
