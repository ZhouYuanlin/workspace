...
<html>
	...
	<form id="frm" action="<c:url value='${request.contextPath}/retinfo'/>"  class="form-horizontal" method="post">
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="controls">
																<select name="xsdy"  id="xsdy" class="form-control col-md-12">
										                            <option value="">----请选择----</option>
												             		<c:forEach items="${codeDyb}" var="item">
			  ...
			  <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-condensed table-advance table-hover">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>${item.xsdy}</td>
                                    <td title="${item.familys[0].jtdz}"><s:substring length="8" value="${item.familys[0].jtdz}"/></td>
                                    <td>${item.lxdh}</td>
                                </tr>
                                </c:forEach>
							...
							<div class="pagination pull-right">
								<s:pagination page="${paginate.page}" namespace="/" controller="retinfo" includeParams="false" formWay="true" formId="frm" styleClass="pages fl_r"/>
							</div>
              		</div>
				</div>
			</div>
