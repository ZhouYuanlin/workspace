			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/retsalute/update'/>" class="form-horizontal" method="post">
											<input type="hidden" name="id" value="${r.id}"/>
											<input type="hidden" name="sfzhs" id="sfzhs" value="<c:forEach items='${recs}' var='chi' varStatus='c'>${chi.sfzh}<c:if test='${!c.last}'>,</c:if></c:forEach>"/>
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
													...
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<input type="text" id="wwsj" name="wwsj" value="${r.wwsj}" class="form-control col-md-12 date-picker" data-date-format="yyyy-mm-dd" size="20" readonly/>
															</div>
														</div>
													</div>
													<div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
															...
															<div class="controls">
																<select id="zxzt" name="zxzt" class="form-control col-md-12">
																	<option value="未执行" <c:if test="${r.zxzt == '未执行'}">selected</c:if>>未执行</option>
																	<option value="已执行" <c:if test="${r.zxzt == '已执行'}">selected</c:if>>已执行</option>
																	<option value="取消" <c:if test="${r.zxzt == '取消'}">selected</c:if>>取消</option>
																</select>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="controls">
																<a href="#showdetail" id="approve1" class="black" data-toggle="modal"><input type="text" id="rets" name="rets" value="${r.rets}" class="form-control col-md-12" readonly></a>
															</div>
														</div>
													</div>
												</div>
