			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/meetingApply/update'/>" class="form-horizontal" method="post">
												...
												<div class="col-md-4">
													...
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<input type="text" id="applicantName" name="applicantName" value="${meeting.applicantName}" class="form-control col-md-12" >
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="controls">
																<input type="text" id="useTime" name="useTime" value="${meeting.useTime}" class="form-control col-md-12 date-picker" data-date-format="yyyy-mm-dd" size="16" readonly/>
															</div>
														</div>
													</div>
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<div class="input-group">
																	...
																	<input type="text" id="startTime" name="startTime" value="<c:if test='${empty meeting.startTime}'><fmt:formatDate value='${w.createDate}' pattern='HH:mm'/></c:if><c:if test='${!empty meeting.startTime}'>${meeting.startTime}</c:if>" class="form-control timepicker timepicker-24" style="width:120px;">
													...
													<div class="col-md-4">
                                                        <div class="form-group">
															...
															<div class="controls">
																<div class="input-group">
																	<span class="input-group-btn">
																	<input type="text" id="endTime" name="endTime" value="<c:if test='${empty meeting.endTime}'><fmt:formatDate value='${w.createDate}' pattern='HH:mm'/></c:if><c:if test='${!empty meeting.endTime}'>${meeting.endTime}</c:if>" class="form-control timepicker timepicker-24" style="width:120px;">
																	<button class="btn default timepicker-btn" type="button"><i class="fa fa-clock-o"></i></button>
																	</span>
																</div>
															</div>
