			  ...
			  <div class="row">
			        ...
			        <div class="portlet box grey">
									...
									<div class="portlet-body form">
										<form id="frm" action="<c:url value='${request.contextPath}/retirepartywork/update'/>" class="form-horizontal" method="post">
											<input type="hidden" name="id" value="${p.id}"/>
											<input type="hidden" id="cfsf" name="cfsf" value="${p.cfsf}"/>
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
