        ...
        <div class="ps-right fr">
            <div class="row ps-row">
                <div class="form-group col-md-5">
                    ...
                    <input type="text" style="cursor: pointer;" id="kssj" name="kssj" value="${kssj}" class="form-control col-md-7 date-picker" data-date-format="yyyy-mm-dd" size="16" readonly>
                </div>
                <div class="form-group col-md-5 col-md-offset-1">
                    <label for="exampleInputEmail2" class="col-md-5">体检时间(止)：</label>
                    <input type="text" style="cursor: pointer;" id="jzsj" name="jzsj" value="${jzsj}" class="form-control col-md-7 date-picker" data-date-format="yyyy-mm-dd" size="16" readonly>
                </div>
