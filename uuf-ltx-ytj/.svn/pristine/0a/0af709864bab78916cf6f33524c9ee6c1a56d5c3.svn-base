...
public class id100sdk
{
	 ...
	 * @return 成功返回1;失败返回0
	 */
	public native static int ExportCardImageV();

	/**
	 * 导出横版身份证正反两面jpg图片
	 * @return 成功返回1;失败返回0
	 */
	public native static int ExportCardImageH();
	 ...
	 * @return 成功返回1;失败返回0
	 */
	public native static int ExportCardImageF();

	/**
	 * 导出横版身份证反面jpg图片
	 * @return 成功返回1;失败返回0
	 */
	public native static int ExportCardImageB();
	...
	/**
	 * 获取竖版身份证正反两面jpg图片base64编码
	 * @return 返回竖版身份证正反两面jpg图片base64编码
	 */
	public native static String getJPGCardBase64V();
	
	/**
	 * 获取横版身份证正反两面jpg图片base64编码
	 * @return 返回横版身份证正反两面jpg图片base64编码
	 */
	public native static String getJPGCardBase64H();
	
	
	/**
	 * 获取竖版身份证正面jpg图片base64编码
	 * @return 返回竖版身份证正面jpg图片base64编码
	 */
	public native static String getJPGCardBase64F();
	
	/**
	 * 获取横版身份证反面jpg图片base64编码
	 * @return 返回横版身份证反面jpg图片base64编码
	 */
	public native static String getJPGCardBase64B();
