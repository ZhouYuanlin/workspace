...
* @ClassName: Filter 
* @author tangpeng 
* @date 2015年8月17日 下午10:05:10 
*
*/
public class Filter implements Serializable {
	
	private static final long serialVersionUID = -4217436247589266237L;
	 ...
	 * @return
	 */
	public static Filter sqlRestriction(String property,Object obj){
		return new Filter(property,Operator.sqlRestriction,obj);
	}
