...
public class Retireactivity extends BaseDomain{
	...
	private String htmlcode;			//活动内容htmlcode
	private String coverimg;			//封页图url
	
	public Retireactivity() {
		super();
	}
	
	public Retireactivity(String title, String xzlx, String xzzz, String cyzh,
			String xzcy, String lxdh, Integer hdcs, Date createDate,
			String htmlcode, String coverimg) {
		super();
		this.title = title;
		this.xzlx = xzlx;
		this.xzzz = xzzz;
